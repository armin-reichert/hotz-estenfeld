...
\begin{center}
\input{figures/chapter1/graph_cycle.tikz}
\end{center}
...
\begin{center}
\input{figures/chapter1/edge_ordering.tikz}
\end{center}
...
Notation: 
\[ \pathcat{G}(v, v') := \{ \pi \in \pathcat{G} \mid Q(\pi) = v,\ Z(\pi) = v' \}
\]
...
$G_1$:
\begin{center}
\input{figures/chapter1/bin_tree.tikz}
\end{center}
...
$G_2$:
\begin{center}
\input{figures/chapter1/two_loops.tikz}
\end{center}
...
$G_1$:
\begin{center}
\input{figures/chapter1/chapter1-4-example2.tikz}
\end{center}
...
$G_1$:
\begin{center}
\input{figures/chapter1/chapter1-4-example4-g1.tikz}
\end{center}

$G_2$:
\begin{center}
\input{figures/chapter1/chapter1-4-example4-g2.tikz}
\end{center}
...
\begin{center}
\input{figures/chapter1/chapter1-4-example5.tikz}
\end{center}
...
\begin{definition}[ordered functor]
...
\begin{center}
\input{figures/chapter1/ordered-functor.tikz}
\end{center}
...
\bigskip
\begin{definition}[regular functor]
...
\bigskip
\begin{definition}[out-regular functor]
Let $G_1=(V_1,E_1),\ G_2=(V_2,E_2)$ be oriented graphs and
\[ \phi = (\pathcat{G_1}, \pathcat{G_2}, \phi_1, \phi_2)\text{ a functor.}
\]
